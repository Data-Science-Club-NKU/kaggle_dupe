              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300">
                    Predict based on features of the abalone dataset.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1 text-amber-600 dark:text-amber-400">
                    ...
                    <span className="font-medium">Deadline: March 31st, 11:59 P.M.</span>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                  or <span className="text-indigo-600 dark:text-indigo-400 font-medium">click to browse</span> (.CSV only)
                </p>
              </div>
            </>
          )}
